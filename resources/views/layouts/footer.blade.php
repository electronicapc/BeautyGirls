		    <footer class="nb-footer">
				...
				<div class="footer-info-single">
					...
					<ul class="list-unstyled">
						<li><a href="http://www.nextbootstrap.com/" title=""><i class="fa fa-angle-double-right"></i> Como pagar</a></li>
				...
				<div class="footer-info-single">
					<h2 class="title">Centro de ayuda</h2>
					<ul class="list-unstyled">
						<li><a href="http://www.nextbootstrap.com/" title=""><i class="fa fa-angle-double-right"></i> Acerca de Nosotros</a></li>
						<li><a href="http://www.nextbootstrap.com/" title=""><i class="fa fa-angle-double-right"></i> Contactenos</a></li>
					</ul>
				</div>
				</div>
				<!--
